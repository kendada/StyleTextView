...
public abstract class BaseEditText extends AppCompatEditText implements TextWatcher {
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (tagList != null && tagList.size() > 0){
            ...
            for (TextStylePhrase.TextSize textSize : tagList) {
                textStylePhrase.setForegroundColorSpan(getForegroundColor(), textSize);
    ...
    public abstract List<TextStylePhrase.TextSize> searchAllTextSize(TextStylePhrase textStylePhrase, String text);
